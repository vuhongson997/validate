                    ...
                    <div class="card-body">
                        <form name="my-form" action="{{route('register')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="date" id="present_address" class="form-control" name="birthday">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="phone_number" class="col-md-4 col-form-label text-md-right">ID Number</label>
                                <div class="col-md-6">
                                    <input type="text" id="Id_number" class="form-control" name="idnumber">
                                </div>
                            </div>
